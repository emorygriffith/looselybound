...
function custom_post_example() {
	...
	register_post_type( 'trails', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Trails', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Trail', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'All Trails', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Add New Trail', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit Trails', 'bonestheme' ), /* Edit Display Title */
			...
			'rewrite'	=> array( 'slug' => 'trails', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'trails', /* you can rename the slug here */
	...
	register_taxonomy_for_object_type( 'category', 'trails' );
	/* this adds your post tags to your custom post type */
	register_taxonomy_for_object_type( 'post_tag', 'trails' );
	...
	*/
	...
	register_taxonomy( 'custom_cat',
		array('trails'), /* if you change the name of register_post_type( 'trails', then you have to change this */
